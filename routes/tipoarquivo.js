...
<head>
    ...
    <title>Editar Tipo Arquivo - Arker Data Admin</title>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group" style="display: none;">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tipoArquivoNovo" name="tipoArquivoNovo" value="${tipoArquivo.TipoArquivo}" required>
                                  </div>
                                  <div class="form-group">
